...
export class RealTimeChart extends Component {
    ...
    componentDidMount() {
        ...
        stockChart.theme.gridColor1 = new Charting.Drawing.Color("#000000");
        stockChart.theme.gridColor2 = new Charting.Drawing.Color("#000000");
        ...
        stockChart.plot.seriesStyle = new Charting.CandlestickSeriesStyle(
            new Charting.Drawing.Brush("#FF0000"),
            new Charting.Drawing.Brush("#00FF00"),
        ...
        stockChart.theme.axisLabelsBrush = stockChart.theme.axisTitleBrush = stockChart.theme.axisStroke =
            new Charting.Drawing.Brush("#fff");
    ...
    render() {
        return (
            <div>
                <canvas width="1450px" height="700px" ref={this.el}></canvas>
            </div>
        );
    }
